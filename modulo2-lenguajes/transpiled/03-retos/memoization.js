...
const title10 = "RETOS-MEMOIZATION";
...
const memoize = (func) => {
    const cache = {}; //3 Se establece el objeto cache (key,value)
...
let counter = 0; // Contabiliza cuantas veces se llama la funcion repeatText
const repeatText = (repetitions, text) => (counter++, `${text} `.repeat(repetitions).trim());
const newMemoize = (func) => {
    const cache2 = {};
    return (arg1, arg2) => {
