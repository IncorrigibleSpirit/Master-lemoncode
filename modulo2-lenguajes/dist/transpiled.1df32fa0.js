...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"transpiled/00-variables/variables.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.objectElement1 = exports.b = exports.arrayElements3 = exports.arrayElements2 = exports.arrayElements1 = exports.a = void 0;
// DATA
var title0 = "DATA";
console.log("%c ".concat(title0), "font-weight: bold;");
var arrayElements1 = exports.arrayElements1 = [1, "hola", true, 4, 888];
var arrayElements2 = exports.arrayElements2 = [2588, "id", "passport"];
var arrayElements3 = exports.arrayElements3 = [22, 45, 66, 1, 78, 96];
var objectElement1 = exports.objectElement1 = {
  Id: 2345455,
  passport: "Ac345678",
  country: "ENG",
  address: ""
...
console.log("Array de elementos #1: [".concat(arrayElements1, "]"));
console.log("Array de elementos #2: [".concat(arrayElements2, "]"));
console.log("Array de elementos #3: [".concat(arrayElements3, "]"));
...
},{"base64-js":"node_modules/base64-js/index.js","ieee754":"node_modules/ieee754/index.js","buffer":"node_modules/buffer/index.js"}],"node_modules/lodash/lodash.js":[function(require,module,exports) {
...
},{"buffer":"node_modules/buffer/index.js"}],"transpiled/01-practica/practica.js":[function(require,module,exports) {
"use strict";
...
//Libreria para trabajar igualdad de objetos (_.isEqual())
//*************************************//
// 101 BIGGEST WORD: Crea una función que reciba una frase en formato string y devuelva la palabra más larga.
//*************************************//
var biggestWord = function biggestWord(phrase) {
  var words = phrase.split(" ");
  var biggest = words.sort(function (a, b) {
...
function printAverage(classResults) {
  var scoreList = values(classResults);
  var totalScore = scoreList.reduce(function (acc, score) {
    return acc + score;
  }, 0);
  var averageScore = totalScore / scoreList.length;
...
function scoreLevel(score) {
  switch (score) {
    ...
    default:
      return "Valor err\xF3neo: ".concat(score);
  }
}
var scoreAverage = printAverage(eso2o);
var performanceLevel = scoreLevel(scoreAverage);
function objectValues(obj) {
  var resultValues = Object.values(obj);
  return resultValues;
}
...
//*************************************//
var input = function input(argument) {
  return argument !== null && argument !== undefined ? console.log(argument) : console.log("argument is required");
};
//input(undefined);
//input(null);
//*************************************//
...
function isDeepEqual(elementA, elementB) {
  if (_typeof(elementA) !== "object" || _typeof(elementB) !== "object" || elementA === null || elementB === null) return false;
  return _lodash.default.isEqual(elementA, elementB);
}
var basicUser = {
  name: "María",
  age: 30,
...
function rollTheDice() {
  ...
  function dice2() {
    ...
    function diceResult() {
      if (dice1 === 6 && dice2 === 6) {
        console.log("\xA1Ganaste 1.000 USD! (Valor dado 1: ".concat(dice1, ". Valor dado 2: ").concat(dice2, ")"));
      } else {
        console.log("\xA1Intenta nuevamente! (Valor dado 1: ".concat(dice1, ". Valor dado 2: ").concat(dice2, ")"));
      }
    }
    return diceResult;
  }
...
var highestScore = function highestScore(value) {
  var arrangedArray = _toConsumableArray(value).sort(function (a, b) {
    return b - a;
  });
  return Number(arrangedArray[0]);
};
var average = function average(value) {
  var sum = value.reduce(function (acc, score) {
    return acc + score;
  }, 0);
  var avg = sum / value.length;
  return avg.toFixed(2);
};
var summarizeClassRoom = function summarizeClassRoom(studentsData) {
...
// ]
},{"lodash":"node_modules/lodash/lodash.js"}],"transpiled/02-entregables/ejercicio-01.js":[function(require,module,exports) {
"use strict";

var _variables = require("../00-variables/variables");
...
//ARRAY OPERATIONS
var title1 = "ENTREGABLES - ARRAY OPERATIONS";
console.log("%c ".concat(title1), "font-weight: bold;");
//(HEAD) Función (inmutable) que extraiga y devuelva el 1er elemento. Utiliza destructuring.
var extractHeadElement = function extractHeadElement(_ref) {
  var _ref2 = _slicedToArray(_ref, 1),
    firstItem = _ref2[0];
  return firstItem;
};
var extractFirstElement = extractHeadElement(_variables.arrayElements1);
console.log("HEAD:");
...
var extractTailElement = function extractTailElement(_ref3) {
  var _ref4 = _toArray(_ref3),
    rest = _ref4.slice(1);
  return rest;
};
var extractLastElement = extractTailElement(_variables.arrayElements1);
console.log("TAIL:");
console.log(extractLastElement);
console.log("------------------------");
//(INIT) función (inmutable) que, dado un array devuelva todos los elementos menos el último.
var allExceptLast = function allExceptLast(array) {
  return array.slice(0, -1);
};
console.log("ALL EXCEPT LAST:");
console.log(allExceptLast(_variables.arrayElements1));
console.log("------------------------");
//(LAST) función (inmutable) que, dado un array como entrada devuelva el último elemento.
var LastElement = function LastElement(array) {
  return array.slice(-1);
};
console.log("LAST ELEMENT:");
console.log(LastElement(_variables.arrayElements1));
console.log("------------------------");
},{"../00-variables/variables":"transpiled/00-variables/variables.js"}],"transpiled/02-entregables/ejercicio-02.js":[function(require,module,exports) {
"use strict";
...
console.log(concatV2(_variables.arrayElements1, _variables.arrayElements2, _variables.arrayElements3));
console.log("------------------------");
},{"../00-variables/variables":"transpiled/00-variables/variables.js"}],"transpiled/02-entregables/ejercicio-03.js":[function(require,module,exports) {
"use strict";

var _variables = require("../00-variables/variables");
//CLONE AND MERGE
var title3 = "ENTREGABLES-CLONE";
console.log("%c ".concat(title3), "font-weight: bold;");
//2Creamos función generica que clona objetos
var cloneObject = function cloneObject(source) {
  return Object.assign({}, source);
};
//3 Clonamos objetos
var objectCloned = cloneObject(_variables.objectElement1);
console.log("CLONE:");
...
console.log(objectCloned);
console.log("------------------------");
var title4 = "ENTREGABLES-MERGE";
console.log("%c ".concat(title4), "font-weight: bold;");
//MERGE:
...
var mergeObject = function mergeObject(source, target) {
  return Object.assign(Object.assign({}, target), source);
};
var objectsMerged = mergeObject(_variables.a, _variables.b);
...
},{"../00-variables/variables":"transpiled/00-variables/variables.js"}],"transpiled/02-entregables/ejercicio-04.js":[function(require,module,exports) {
"use strict";
...
var title5 = "ENTREGABLES-READ BOOKS";
console.log("%c ".concat(title5), "font-weight: bold;");
var books = [{
...
var isBookRead = function isBookRead(booklist, bookName) {
  var lowerCaseBookName = bookName.toLowerCase();
  var book = booklist.find(function (item) {
    return item.title.toLowerCase() === lowerCaseBookName;
  });
  return book ? book.read : false;
};
//4
var bookNameInput = "Harry Potter y la piedra filosofal";
var bookreaded = isBookRead(books, bookNameInput);
console.log("\xBFEl libro \"".concat(bookNameInput, "\" ha sido le\xEDdo? ").concat(bookreaded));
console.log("------------------------");
},{}],"transpiled/02-entregables/ejercicio-05.js":[function(require,module,exports) {
"use strict";
...
var title6 = "ENTREGABLES-SLOTH MACHINE";
console.log("%c ".concat(title6), "font-weight: bold;");
var slothMachine = /*#__PURE__*/function () {
  function slothMachine() {
    _classCallCheck(this, slothMachine);
    this.counter = 0;
  }
  return _createClass(slothMachine, [{
    key: "play",
    value: function play() {
      this.counter += 1;
      var roulette1 = Math.random() < 0.5;
      var roulette2 = Math.random() < 0.5;
      var roulette3 = Math.random() < 0.5;
      console.log("valor roulette #1: ".concat(roulette1));
      console.log("valor roulette #2: ".concat(roulette2));
      console.log("valor roulette #3: ".concat(roulette3));
      if (roulette1 && roulette2 && roulette3) {
        console.log("Ganaste ".concat(this.counter, " monedas"));
        this.counter = 0;
      } else {
...
machine1.play();
console.log("------------------------");
},{}],"transpiled/03-retos/console-traces.js":[function(require,module,exports) {
"use strict";
...
var title7 = "RETOS - CONSOLE TRACES";
console.log("%c ".concat(title7), "font-weight: bold;");
...
var showMessage = function showMessage(_a) {
...
var run = function run(triggers) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var _iterator, _step, arrayElement;
...
},{}],"transpiled/03-retos/flatten-array.js":[function(require,module,exports) {
"use strict";
...
var title9 = "RETOS - FLATTEN ARRAY";
console.log("%c ".concat(title9), "font-weight: bold;");
...
var sample = [1, [2, 3], [[], [5, 6, [7, 8, [9]]]]];
var depth = 4; // Desde aqui se ajusta el nivel de profundudidad de aplanamiento
var result = flatPolyfill(sample, depth);
console.log(result);
console.log("------------------------");
},{}],"transpiled/03-retos/memoization.js":[function(require,module,exports) {
"use strict";
...
var title10 = "RETOS-MEMOIZATION";
console.log("%c ".concat(title10), "font-weight: bold;");
var expensiveFunction = function expensiveFunction() {
  console.log("Una única llamada");
  return 3.1415;
};
//2 Se crea una funcion de memorizacion / plantilla que acepta una function "tipo".
var memoize = function memoize(func) {
  var cache = {}; //3 Se establece el objeto cache (key,value)
  //4 Se retorna nueva funcion. Esta toma el argumento numerico de la funcion original.
  return function (arg) {
    var key = JSON.stringify(arg); //5 El numero ingresado es convertido a string. Sera la ["Key"] en cache.
    ...
    var value = func(arg); //8 Se llama funcion original con su argumento a fin de extraer su return => "value"
...
var counter = 0; // Contabiliza cuantas veces se llama la funcion repeatText
var repeatText = function repeatText(repetitions, text) {
  return counter++, "".concat(text, " ").repeat(repetitions).trim();
};
var newMemoize = function newMemoize(func) {
  var cache2 = {};
  return function (arg1, arg2) {
    var key = JSON.stringify([arg1, arg2]);
...
var memoizedGreet = newMemoize(repeatText);
...
// }
},{}],"transpiled/03-retos/tree.js":[function(require,module,exports) {
"use strict";
},{}],"transpiled/03-retos/understandingJs.js":[function(require,module,exports) {
"use strict";

var title11 = "RETOS-UNDERSTANDING JS";
console.log("%c ".concat(title11), "font-weight: bold;");
...
var isNaNValue = function isNaNValue(param) {
...
var count = 1;
var variableX = function variableX() {
  return count--;
};
console.log(variableX() > variableX());
},{}],"transpiled/index.js":[function(require,module,exports) {
"use strict";

require("./00-variables/variables");
require("./01-practica/practica");
require("./02-entregables/ejercicio-01");
require("./02-entregables/ejercicio-02");
require("./02-entregables/ejercicio-03");
require("./02-entregables/ejercicio-04");
require("./02-entregables/ejercicio-05");
require("./03-retos/console-traces");
require("./03-retos/flatten-array");
require("./03-retos/memoization");
require("./03-retos/tree");
require("./03-retos/understandingJs");
},{"./00-variables/variables":"transpiled/00-variables/variables.js","./01-practica/practica":"transpiled/01-practica/practica.js","./02-entregables/ejercicio-01":"transpiled/02-entregables/ejercicio-01.js","./02-entregables/ejercicio-02":"transpiled/02-entregables/ejercicio-02.js","./02-entregables/ejercicio-03":"transpiled/02-entregables/ejercicio-03.js","./02-entregables/ejercicio-04":"transpiled/02-entregables/ejercicio-04.js","./02-entregables/ejercicio-05":"transpiled/02-entregables/ejercicio-05.js","./03-retos/console-traces":"transpiled/03-retos/console-traces.js","./03-retos/flatten-array":"transpiled/03-retos/flatten-array.js","./03-retos/memoization":"transpiled/03-retos/memoization.js","./03-retos/tree":"transpiled/03-retos/tree.js","./03-retos/understandingJs":"transpiled/03-retos/understandingJs.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","transpiled/index.js"], null)
//# sourceMappingURL=/transpiled.1df32fa0.js.map