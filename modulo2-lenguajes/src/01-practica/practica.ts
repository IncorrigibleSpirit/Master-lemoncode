...
type objectTemplate = { [key: string]: number };
...
function values(obj: objectTemplate) {
  return Object.values(obj);
}

function printAverage(classResults: objectTemplate) {
...
//console.log(`El promedio acumulado fue ${scoreAverage}. ${performanceLevel}`);

//*************************************//
//114 VALUES A : Escribe una función que devuelva una lista de valores de todas las propiedades de un objeto:
//*************************************//
type objectModel = { [key: string]: number | string };

function objectValues(obj: objectModel) {
...
// //3 Definicion del metodo prototipo
...
const input = (argument: string | number | null | undefined) =>
  argument !== null && argument !== undefined ? console.log(argument) : console.log("argument is required");
//input(undefined);
//input(null);
...
function isEqual(objectA: objectModel, objectB: objectModel): boolean {
...
//console.log(isEqual(user, anotherUser));

//*************************************//
//105 OBJECT DEEP EQUAL: comparacion de objetos anidados junto con sus claves y valores
//*************************************//

type objectModelSpecial = { [key: string]: number | string | object | string[] };

function isDeepEqual(elementA: objectModelSpecial, elementB: objectModelSpecial): boolean {
