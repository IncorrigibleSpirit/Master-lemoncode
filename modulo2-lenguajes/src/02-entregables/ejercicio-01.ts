...
//ARRAY OPERATIONS
const title1: string = "ENTREGABLES - ARRAY OPERATIONS";
...
const extractHeadElement = <T>([firstItem]: T[]): T => firstItem;
...
const extractTailElement = <T>([, ...rest]: T[]): T[] => rest;
...
const allExceptLast = <T>(array: T[]): T[] => {
