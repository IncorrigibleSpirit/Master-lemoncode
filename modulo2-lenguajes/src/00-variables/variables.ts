// DATA
const title0: string = "DATA";
console.log(`%c ${title0}`, "font-weight: bold;");

export const arrayElements1: (number | string | boolean)[] = [1, "hola", true, 4, 888];
export const arrayElements2: (number | string | boolean)[] = [2588, "id", "passport"];
export const arrayElements3: (number | string | boolean)[] = [22, 45, 66, 1, 78, 96];
